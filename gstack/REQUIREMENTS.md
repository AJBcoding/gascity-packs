...
- Source-completion contract: both gstack implementation paths preserve
  ...
  record open. Proof and self-review close only control steps with
  `gc.outcome`; they never set `gc.work_outcome=shipped`.
